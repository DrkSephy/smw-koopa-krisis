...
MyGame = ig.Game.extend({
    ...
    levelVariables: [ LevelMainlevel1, LevelForestRuins, LevelMaincastle, LevelBunchADoors, LevelDeepForest,
                      LevelMushroomForest1, LevelMushroomForest2 ],

    levelMusic: ['Final', 'MarbleHillZone', 'madness_fortress', 'amour_toujours', 'madness_fortress', 
