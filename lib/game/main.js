...
// Start Game Over Screen
	...
	GameOverScreen = ig.Game.extend({
		...
		draw: function(){
			...
			this.font.draw('Total Kills: ' + this.stats.kills, x, y+30, ig.Font.ALIGN.CENTER);
			this.font.draw('Total Deaths: '+ this.stats.deaths, x, y+40, ig.Font.ALIGN.CENTER);
			this.font.draw('Score: ' + score, x, y+50, ig.Font.ALIGN.CENTER);
