...
MyGame = ig.Game.extend({
    ...
    levelVariables: [ LevelForestRuins, LevelCastle, LevelFloatinggrassland, LevelBunchADoors, LevelDeepForest,
                      LevelMushroomForest1, LevelMushroomForest2 ],

    levelMusic: ['MarbleHillZone', 'Final', 'madness_fortress', 'amour_toujours', 'madness_fortress', 
                 'amour_toujours', 'battle_bossonova'],
