...
MyGame = ig.Game.extend({
    ...
    lifeSprite: new ig.Image('media/hud/mario_hud.png'),
    coinSprite: new ig.Image('media/hud/coin_hud.png'),
    ...
    coins: 0, // Keep track of number of coins
    activePower: null, // Keep track of current powerup

    levelVariables: [ LevelSnowy, LevelUndergroundsnow, LevelMainlevel1, LevelOutdoorcastle,LevelForestRuins,
                      LevelDesert, LevelUndergrounddesert, LevelMountain, LevelMaincastle, LevelBoss1lair ],

    levelMusic: ['snowman', 'barrel_volcano', 'maze', 'snake_man', 'tarm_ruins',
                 'desert', 'ryu', 'dark_world', 'madness_fortress', 'epic_boss'],
    ...
    StartScreen = ig.Game.extend({
     ...
     CreditsScreen = ig.Game.extend({
        ...
        draw: function(){
            ...
            var x = ig.system.width/2,
            y = ig.system.height/2;
            this.font.draw('Press the Spacebar to Start Playing!', x, y + 110, ig.Font.ALIGN.CENTER);
        } // End draw
