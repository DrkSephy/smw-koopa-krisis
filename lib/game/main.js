...
MyGame = ig.Game.extend({
    ...
    levelVariables: [ LevelMainlevel1, LevelForestRuins, LevelMaincastle, LevelBoss1lair,
                      LevelBunchADoors, LevelDeepForest, LevelMushroomForest1, LevelMushroomForest2 ],

    levelMusic: ['Mari', 'MarbleHillZone', 'madness_fortress', 'amour_toujours',
                 'amour_toujours', 'madness_fortress', 'amour_toujours', 'battle_bossonova'],
