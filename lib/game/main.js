...
MyGame = ig.Game.extend({
    ...
    levelVariables: [ LevelGauntlet, LevelBest_overworld, LevelSnowy, LevelUndergroundsnow, LevelUndergrounddesert, LevelMainlevel1, LevelOutdoorcastle, LevelForestRuins,
                      LevelDesert, LevelMountain, LevelMaincastle, LevelBoss1lair ],

    levelMusic: ['snake_man', 'map_theme', 'snowman', 'barrel_volcano', 'ryu', 'maze', 'snake_man', 'tarm_ruins',
