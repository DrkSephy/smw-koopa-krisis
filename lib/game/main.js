...
MyGame = ig.Game.extend({
    ...
    levelVariables: [ LevelTutorial, LevelBest_overworld, LevelSnowy, LevelUndergroundsnow, LevelUndergrounddesert, LevelMainlevel1, LevelOutdoorcastle, LevelForestRuins,
                      LevelDesert, LevelMountain, LevelMaincastle, LevelBoss1lair, LevelGauntlet, LevelGauntlet2, LevelFinalGauntlet],

    levelMusic: ['smw_remix', 'map_theme', 'snowman', 'barrel_volcano', 'ryu', 'maze', 'snake_man', 'tarm_ruins',
                 'desert', 'dark_world', 'madness_fortress', 'epic_boss', 'wily_castle', 'wily_castle', 'bowser_battle'],
