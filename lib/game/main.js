...
MyGame = ig.Game.extend({
	...
	levelVariables: [LevelDeepForest,LevelMushroomForest1, LevelMushroomForest2],
	levelNames: ['DeepForest','mushroomForest1', 'mushroomForest2'],
