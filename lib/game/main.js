...
MyGame = ig.Game.extend({
    ...
    loadLevel: function(data) {
        ...
        var final_sprite = new ig.AnimationSheet('media/finalSprite.png', 16, 16);
        //other
        ...
        'media/finalSprite.png':{
        0: new ig.Animation(final_sprite, 0.40, [0,1,2,3])
        },
    ...
    draw: function() {
        ...
        if(this.showStats) {
            ...
            if(this.lives >= this.bonusReqLives) {
