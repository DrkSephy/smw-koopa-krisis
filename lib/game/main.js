...
MyGame = ig.Game.extend({
    ...
    var fire_flower = new ig.AnimationSheet('media/world_map.png', 16, 16);
    var dugtrio = new ig.AnimationSheet('media/world_map.png', 16, 16);
    ...
    this.backgroundAnims = {
       ...
       'media/world_map.png': {
        16: new ig.Animation(fire_flower, 0.2, [16,17,18,19])
       },
       'media/world_map.png':{
        20: new ig.Animation(dugtrio, 0.2, [20, 21, 22, 23])
       },
       'media/world_map.png':{
        12: new ig.Animation(world_water, 0.2, [12, 13, 14, 15])
        },
...
// pass the reference of the game class we want to display.
    ...
    OverWorld = ig.Game.extend({
        ...
        loadLevel: function(data){
            ...
            this.backgroundAnims = {
                'media/world_map.png': {
                    16: new ig.Animation(fire_flower, 0.40, [16,17,18,19])
                }
