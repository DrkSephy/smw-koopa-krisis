...
MyGame = ig.Game.extend({
	...
	megaMari: new ig.Sound('media/sounds/Final.ogg'),
	theme : new ig.Sound('media/sounds/theme.ogg'),

	myDirector : new ig.Director(this, [LevelTest, LevelTest2]),
	...
	update: function() {
		...
		/*
		ig.game.getEntitiesByName(EntityLevelexit).collidesWith = function(other){ 
