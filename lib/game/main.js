...
MyGame = ig.Game.extend({
	...
	levelVariables: [LevelMushroomForest1, LevelMushroomForest2],
	levelNames: ['mushroomForest1', 'mushroomForest2'],
	levelMusic: ['Final', 'Final'],
  ...
  // var water = new ig.AnimationSheet('media/fg/water.png', 32, 128);
  // this.backgroundAnims = {
  //    'media/fg/water.png': {
  //      0: new ig.Animation(water, 0.4, [0,1,2,3,1,2,3]),
  //      1: new ig.Animation(water, 0.4, [18,18,18,18]),
  //    }
  //  };
