...
MyGame = ig.Game.extend({
    ...
    levelVariables: [ LevelFinalGauntlet, LevelBest_overworld, LevelSnowy, LevelUndergroundsnow, LevelUndergrounddesert, LevelMainlevel1, LevelOutdoorcastle, LevelForestRuins,
