...
.defines(function() {
    EntityPlayer = ig.Entity.extend({
        ...
        shootSFX: new ig.Sound('media/sounds/throw_fireball.*'),
        deathSFX: new ig.Sound('media/sounds/death.*'),
        losePowerSFX: new ig.Sound('media/sounds/lose_powerup.*'),
        ...
        // add it to each animation.
            ...
            this.addAnim('hammer_idle', 1, [6]);
            this.addAnim('hammer_run', 0.10, [6,5]);
            this.addAnim('hammer_jump', 1, [7]);
            this.addAnim('hammer_shoot', 0.3, [9,8]);
            this.addAnim('hammer_fall', 0.4, [7]);
            this.addAnim('fire_idle', 1, [11]);
            this.addAnim('fire_run', 0.10, [11,10]);
            this.addAnim('fire_jump', 1, [12]);
            this.addAnim('fire_shoot', 0.3, [14,13]);
            this.addAnim('fire_fall', 0.4, [12]);
        ...
        handleMovementTrace: function(res) {
            ...
            /* Modify Player's behavior for slope collision and movement speed (Kevin) */
            ...
            /* End modification of Player's behavior for slope collision and movement speed */
        },
