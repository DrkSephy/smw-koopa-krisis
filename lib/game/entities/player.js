        ...
        handleMovementTrace: function(res) {
            ...
            if(res.collision.slope) {
                ...
                if(!ig.input.state('right') && !ig.input.state('left')) {
                    ...
                    // Prevents player from being stuck in "jump" or "run" animation when idle on slopes.
                    this.vel.x = 0;
                    this.vel.y = 0;
                // Left/right key is pressed (player is moving up/down slope).
                    ...
                    vx = Math.abs(this.maxVel.x * res.collision.slope.x / hyp);
                    vy = Math.abs(this.maxVel.x * res.collision.slope.y / hyp);
                    ...
                    this.friction.x = 0; // Reduces player showing "jump" animation when walking up slopes.
                    this.friction.y = 60; // Reduces player showing "fall" animation when walking down slopes.
                }
            } else {
            ...
            if( ig.input.pressed('switch') ) {
             ...
             this.weapon = 0;
                switch(this.weapon){
                 ...
                 break;
                 case(1):
                 this.activeWeapon = "EntityHammer";
                 break;
                }
               // this.setupAnimation(this.weapon);
            }
