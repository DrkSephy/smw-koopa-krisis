/*
	1) stalk 
	2) squish state ?shoot projectiles
	3) shooting
	4) jumping
...
//override
        ...
        update: function() {
            ...
            if(my_player != null) {
                ...
                console.log(my_player.standing);
                ...
                {    
                    ...
                    else if (!isCollapsed && this.face && this.shootTimer.delta() > 2)
                    {         
                    	//console.log("shoot");
						// Fire bullet left
						ig.game.spawnEntity(EntityBalls, this.pos.x - 11, this.pos.y+1, {flip: this.flip});
						ig.game.spawnEntity(EntityBalls, this.pos.x - 20, this.pos.y+3, {flip: this.flip});
						// Fire bullet right
						ig.game.spawnEntity(EntityBalls, this.pos.x + 27, this.pos.y+1, {flip: !this.flip}); 
						ig.game.spawnEntity(EntityBalls, this.pos.x + 36, this.pos.y+3, {flip: !this.flip}); 
