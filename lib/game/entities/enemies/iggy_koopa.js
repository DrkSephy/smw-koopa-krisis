        ...
        update: function() {
            ...
            if(this.ai_state != 3) {
                if(this.health <= this.ai_state_health.annoyed && this.health > this.ai_state_health.angry && this.ai_state == 0) {
                    ...
                    this.attack_interval.min = 0.5; // Increase frequency of attacks
                    this.attack_interval.max = 1; // Increase frequency of attacks
                    ...
                    this.jump_height.min *= 1.5; // Increase jump height
                    this.jump_height.max *= 1.5; // Increase jump height
                    this.ai_state = 3;
                }
            }
