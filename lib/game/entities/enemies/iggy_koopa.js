        ...
        update: function() {
            ...
            if(!inShell) {
                ...
                if(my_player != null) {
                    ...
                    if((!this.icu && Math.abs(target_x - this.pos.x) <= this.icu_check_dist.x && Math.abs(target_y - this.pos.y) <= this.icu_check_dist.y) || this.health < init_health) {
                    ...
                    } else if(this.icu && Math.abs(target_x - this.pos.x) <= this.icu_chase_dist.x && Math.abs(target_y - this.pos.y) <= this.icu_chase_dist.y) {
