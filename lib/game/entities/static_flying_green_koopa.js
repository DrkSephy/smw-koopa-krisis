...
ig.module(
  'game.entities.static_flying_green_koopa'
)
...
.defines(function(){
  EntityStatic_flying_green_koopa = ig.Entity.extend({
    ...
    update: function(){
        ...
        if((xdist <= (ig.system.width - 50)) && (ydist <= 50)){
          ...
          ig.game.spawnEntity(EntityFlying_green_koopa, this.pos.x, this.pos.y);
