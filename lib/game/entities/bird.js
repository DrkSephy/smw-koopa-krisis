...
EntityBird = ig.Entity.extend({
    ...
    update: function() {
        ...
        // Entity is nearby to the player
        if(this.distanceTo(my_player) < 100) {

            if (this.bombCounters < 1) {
                ig.game.spawnEntity( EntityBirdBomb, this.pos.x, this.pos.y);
                this.bombCounters++;
            }
