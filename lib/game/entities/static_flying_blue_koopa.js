...
ig.module(
  'game.entities.static_flying_blue_koopa'
)
...
.defines(function(){
  EntityStatic_flying_blue_koopa = ig.Entity.extend({
    ...
    update: function(){
        ...
        if((xdist <= (ig.system.width - 50)) && (ydist <= 50)){
          ...
          ig.game.spawnEntity(EntityFlying_blue_koopa, this.pos.x, this.pos.y);
